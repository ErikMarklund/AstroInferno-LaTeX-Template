...
\begin{AIMonster}[float=htb,width=\columnwidth]{Void cult accolyte}
    ...
    \AIMonsterTroubles{Shoot: 6~\AIdamagesymbol, Cower: \AIbonessymbol +1}{{Suicide bomb: 15~\AIdamagesymbol,
        area}, Frenzy: \AIdamagesymbol +3}
    ...
    {\AIchestsymbol~{(-4)},\AIbloodsymbol~Soiled blood}
    {one}
\end{AIMonster}
...
\begin{AIMonster}[float=htb,width=\columnwidth, fonttitle=\fontsize{30}{35}\AIfontFeathergraphyDecoration]{Void cult demagogue}
    \AIMonsterType{Void priests - Obliviation deacons}
    \AIMonsterClass{Champions}
    \AIMonsterBeing{Greater souls}
    \AIMonsterBasics{6}{6}{3}
    \AIMonsterTroubles{Punishment: 10~\AIdamagesymbol, Glossolalia:
      \AIdamagesymbol +2, Support: +5 Accolytes}{Possess one character, Curse: Party disadvantage}
    ...
    {\AIchestsymbol~{(-4)},\AIbloodsymbol~Normal blood}
    {one}
\end{AIMonster}
\part{Customization}
